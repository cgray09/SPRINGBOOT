...
public class Product {
    ...
    @Column(name = "category_id") // needed since the actual name of the column in the db is "category_id"
    private String categoryId;

    @Column(name = "created_at", updatable = false)
    @CreationTimestamp // creates timestamp automatically when a product is made
