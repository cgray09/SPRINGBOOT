...
import com.caveofprogramming.service.AWSS3Service;
...
public class ProfileController {
	...
	public ModelAndView showProfile() {
        ...
        System.out.printf("SJJJJJJJJJJJSSSSSSSSSSSSSSS: ");
		...
		modelAndView.getModel().put("photo", profile.getPhotoName());
	...
	public ResponseEntity<PhotoUploadStatus> handlePhotoUploads(@RequestParam("file") MultipartFile file) {
		...
		String file_name = service.uploadFile(file);
		SiteUser user = getUser();
		Profile profile = profileService.getUserProfile(user);
		final File fileNew = convertMultiPartFileToFile(file);
		profile.setPhotoName(fileNew.getName());
		profileService.save(profile);
//		System.out.printf("SJJJJJJJJJJJSSSSSSSSSSSSSSS: " + fileNew.getName() + "  ");
