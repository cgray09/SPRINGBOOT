	...
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="profile-about">
			...
			<div class="profile-image">
				<div >
					<img  style="height: 200px; width: 200px;" id="profilePhotoImage" src="https://django-devsearch.s3.us-west-1.amazonaws.com/${photo}" />
				</div>
		...
		<div class="profile-about-edit">
			<c:if test="${ownProfile == true}">
				<a style="font-size: 30px;" href="${editProfileAbout}">edit</a>
			</c:if>
...
<script>
	...
	function uploadSuccess(data) {
		...
		$("#profilePhotoImage").attr("src", "https://django-devsearch.s3.us-west-1.amazonaws.com/${photo}");
